		...
		"<head>"
			...
			"<script>"
				...
				"function updateProgramState(state) {"
					...
					"switch (state) {"
						"case 1:"
							"state_text = 'Reaching the active sensor';"
							"break;"
						"case 2:"
							"state_text = 'Reaching than controlling at active sensor';"
							"break;"
						"case 3:"
							"state_text = 'Controlling vlonder at active sensor';"
							"break;"
						"case 4:"
							"state_text = 'Reaching upper limit switch';"
							"break;"
						"case 5:"
							"state_text = 'Reaching lower limit switch';"
							"break;"
						"case 6:"
							"state_text = 'Web control manual up';"
							"break;"
						"case 7:"
							"state_text = 'Web control manual down';"
							"break;"
						"case 8:"
							"state_text = 'Remote control manual up';"
							"break;"
						"case 9:"
							"state_text = 'Remote control manual down';"
							"break;"
						"case 0:"
						"default:"
							"state_text = 'none';"
				...
				"function webControlManualUp() {"
					"sendProgramStatePost(6);"
				"}"

				"function webControlManualDown() {"
					"sendProgramStatePost(7);"
				"}"
